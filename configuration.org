...
I tried the whole [[https://nixos.wiki/wiki/Import_From_Derivation][IFD]] thing, and before I ~git init~ed, there was an
...
*** TODO Split out into raspberry pi stuff and share stuff
** Home
#+begin_src nix
...
messing with org-mode preview settings to make it use svg, I still was
getting weird square boxes. Come to find out emacs was refusing to
display images bigger than 10x10 pixels. C'mon son.
...
#+end_src
** TODO Understand sharing ssh keys between machines, can't encrypt on kenobi rn
* Systems
** ~kenobi~
#+NAME: kenobi
#+begin_src nix
